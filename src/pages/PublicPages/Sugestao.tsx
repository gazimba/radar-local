...
export function Sugestao() {
    ...
    return (
        <div className="max-w-6xl m-8 p-8 flex flex-col items-center bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden font-sans hover:shadow-md transition-shadow duration-300">
