...
export function PontoTuristicoDetalhes() {
    return (
        <div className="max-w-6xl m-8 p-8 flex flex-col items-center bg-white rounded-3xl shadow-md overflow-hidden font-sans hover:shadow-lg transition-shadow duration-300">
            <h1 className="text-blue-800 font-bold text-2xl uppercase">Basílica do Bom Jesus de Matosinhos</h1>
            <Carrosel />
            <div className="grid grid-cols-3 gap-8 mt-6">
                <div className="col-span-2">
                    <h2 className="text-blue-800 font-bold text-xl mt-6 uppercase">Sobre o local</h2>
                    <p className="text-gray-700 text-lg mt-4">
                        A Basílica do Bom Jesus de Matosinhos é um dos principais pontos turísticos de Congonhas, Minas Gerais.
                    </p>
                    <h3 className="text-blue-800 font-bold text-xl mt-6 uppercase">Destaques</h3>
                    <p className="text-gray-700 text-lg mt-4">
                ...
                <div className="col-span-1 md:border-l md:pl-6">
                    <h2 className="text-blue-800 font-bold text-xl mt-6 uppercase">Informações adicionais</h2>
                    <p className="text-gray-700 text-lg mt-4">
